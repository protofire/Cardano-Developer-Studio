...
### Plutus Development Tools

This container includes a comprehensive suite of tools, libraries, and examples to assist in Plutus smart contract development.

To interact with the Cardano Plutus Development container, you can open a shell within the container using Visual Studio Code (VS Code).
...
Choose the Cardano Plutus Development Tools container from the list.
