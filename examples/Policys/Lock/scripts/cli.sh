...
utxos_in_smart_contracts() {
    ...
    echo "Checking balance in Lock Validator..."
    script_address=$(cat "$selected_scripts/lockValidator-$CARDANO_NETWORK_SUFIX.addr")
