...
import           ParamCheckSignaturePolicy  as OnChain (paramCheckSignaturePolicy, paramCheckSignaturePolicyCode)
...
runDeploy baseFolder = do
    ...
    do
        ...
        ------------------------------
        let policyCode = OnChain.paramCheckSignaturePolicyCode
        DeployHelpers.writeCompiledCodeToJsonFile (path SystemFilePathPosix.</> folderName SystemFilePathPosix.</> "paramCheckSignaturePolicy.plutus") policyCode
        ------------------------------
    return ()
