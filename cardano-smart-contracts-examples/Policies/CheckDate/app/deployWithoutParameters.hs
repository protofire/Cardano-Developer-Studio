...
import           ParamCheckBeforeDeadlinePolicy  as OnChain (paramCheckBeforeDeadlinePolicyCode)
import           ParamCheckAfterDeadlinePolicy  as OnChain (paramCheckAfterDeadlinePolicyCode)
...
runDeploy baseFolder = do
    ...
    do
        ...
        ------------------------------
        let policyCode = OnChain.paramCheckAfterDeadlinePolicyCode
        DeployHelpers.writeCompiledCodeToJsonFile (path SystemFilePathPosix.</> folderName SystemFilePathPosix.</> "paramCheckAfterDeadlinePolicy.plutus") policyCode
    ------------------------------
    do
        P.putStrLn "Generating 'paramCheckBeforeDeadlinePolicy' Script..."
        ------------------------------
        let policyCode = OnChain.paramCheckBeforeDeadlinePolicyCode
        DeployHelpers.writeCompiledCodeToJsonFile (path SystemFilePathPosix.</> folderName SystemFilePathPosix.</> "paramCheckBeforeDeadlinePolicy.plutus") policyCode
    ------------------------------
    return ()
