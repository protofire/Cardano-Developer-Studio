...
select_contract() {
    selected_validator="alwaysFalseValidator"
...
utxos_in_smart_contracts() {
    ...
    echo "Checking balance in AlwaysFalse Validator..."
    script_address=$(cat "$selected_scripts/alwaysFalseValidator-$CARDANO_NETWORK_SUFIX.addr")
